...
class DisplayPort {
 public:
  bool begin(){
    ...
    buf1_=(lv_color_t*)heap_caps_malloc(480*60*sizeof(lv_color_t),MALLOC_CAP_DMA);if(!buf1_)return false;
 ...
 private:
  ...
  Arduino_ESP32RGBPanel* rgb_=new Arduino_ESP32RGBPanel(40,39,38,41,46,3,8,18,17,14,13,12,11,10,9,5,45,48,47,21,1,10,8,50,1,10,8,20,0,12000000,false,0,0,480*40);
