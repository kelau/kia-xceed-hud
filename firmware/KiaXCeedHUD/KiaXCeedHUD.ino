...
void setup(){
  ...
  boardServices.begin();Serial.printf("Board services: SD %s, battery IC %s, buzzer %s\n",boardServices.sdMounted()?"mounted":"unavailable",boardServices.batteryPresent()?"detected":"unavailable",boardServices.buzzerPresent()?"ready":"unavailable");
