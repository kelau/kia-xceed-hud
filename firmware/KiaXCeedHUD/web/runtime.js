(function () {
  ...
  async function compatibility() {
    ...
    if (state.compatibility.uiVersion !== "0.16.5" || state.compatibility.apiVersion !== 2)
      throw new Error(`Incompatible Web UI: expected UI 0.16.5 / API 2, received UI ${state.compatibility.uiVersion} / API ${state.compatibility.apiVersion}`);
